...
module.exports = function(app) {
  ...
  app.use(
    ...
    createProxyMiddleware({
      target: 'http://34.207.208.152:9006',
      changeOrigin: true,
      secure: false,
      logLevel: 'debug',
      pathRewrite: {
  ...
  app.use(
    '/api/v1/channels',
    createProxyMiddleware({
      target: 'http://34.207.208.152:9005',
      changeOrigin: true,
      secure: false,
      logLevel: 'debug',
      pathRewrite: {
  ...
  app.use(
    '/api/v1/users',
    createProxyMiddleware({
      target: 'http://34.207.208.152:9002',
      changeOrigin: true,
      secure: false,
      logLevel: 'debug',
      pathRewrite: {
  ...
  app.use(
    '/api/v1/readers',
    createProxyMiddleware({
      target: 'http://34.207.208.152:9009',
      changeOrigin: true,
      secure: false,
      logLevel: 'debug',
      pathRewrite: {
  ...
  app.use(
    '/api/v1/http',
    createProxyMiddleware({
      target: 'http://34.207.208.152:8008',
      changeOrigin: true,
      secure: false,
      logLevel: 'debug',
      pathRewrite: {
